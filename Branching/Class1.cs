...
namespace Branching
{
    public class CompareAAndBAndSolve
    {
        static public int Condition1(int a, int b)
        {
            if (a > b)
            {
                return (a + b);
    ...
    public class SearchForQuater
    {
        static public string Quater(int x, int y)
        {
            if (x > 0 && y > 0)
            {
                return ("1-st quater");
    ...
    {
        static public int[] IncreasingNumbers(int a, int b, int c)
        {
            int[] array = new int[3] { a, b, c };
            array = Branching.SortArray.SelectionSort(array);
            return array;
        }
    }
